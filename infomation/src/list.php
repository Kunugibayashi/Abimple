...
<div class="content-wrap">
      ...
      <table>
        ...
        <?php foreach ($infoList as $key => $value) { ?>
          <tr>
            ...
            <?php } ?>
            <td><a href="<?php echo h(INFO_SEC_LINK); ?>view.php?id=<?php echo h($value['id']); ?>"><?php echo h($value['title']); ?></a></td>
  ...
  <form id="edit-form" class="hidden-form" action="<?php echo h(INFO_SEC_LINK); ?>edit.php" method="GET">
    <input type="hidden" name="id" value="jQueryで入力">
  </form>

  <form id="delete-form" class="hidden-form" action="<?php echo h(INFO_SEC_LINK); ?>delete.php" method="GET">
    <input type="hidden" name="id" value="jQueryで入力">
  </form>
