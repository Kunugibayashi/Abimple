    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td>2d6　ここ以降はコメントとして処理されます</td>
        </tr>
        <tr>
          <td>使用可能文字</td>
          <td>数字、d、四則演算記号、括弧、比較記号のみ。間にスペースは使えません。</td>
          <td>1d6 + 10 >= 12</td>
        </tr>
        <tr>
          <td>ダイス上限</td>
          <td>最大 10d100 まで振ることが可能です。</td>
          <td>11d100</td>
        </tr>
        <tr>
          <td>括弧の入れ子</td>
  ...
  <div class="table-wrap">
    <table>
      <tbody>
        ...
        <tr>
          <td>2d6+{自由設定9}>=7　【行動判定】＋補正値（変数）</td>
          <td>2d6+{自由設定9}>=7 【行動判定】＋補正値（変数） ＞ 10[6, 4]+(3)>=7 ＞ 13>=7 ＞ 成功</td>
        </tr>
        <tr>
          <td>2d6>=2d6　左右比較</td>
